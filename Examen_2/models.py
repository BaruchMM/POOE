...
class producto:
    ...
    class empleado:
        def __init__(self,NoEmpleado,Nombre,FechaNacimiento,departameto,ventasActuales,ventasTotales):
            self.__NoEmpleado = NoEmpleado
            self.__Nombrenombre = Nombre
            self.__FechaNacimiento = FechaNacimiento #[dd,mm,aaaa]
            self.__departameto = departameto
            self.__ventasActuales = ventasActuales
            self.__ventasTotales = ventasTotales #dinero acumulado por todas las ventas
